...
const ConsultantsClient = (): JSX.Element => {
  ...
  return (
    <div className="prose mt-12 flex max-w-full flex-col px-[5%] text-justify dark:prose-invert md:px-[20%] 2xl:px-[30%]">
      ...
      <p>
        ...
        individuals that offer consulting services for preparing a Flatpak build
        of an app and submitting it to Flathub. Typically, they would support
        the submission of an app which already has a working Linux version.
      </p>
      ...
      <p>
        ...
        contact them directly if you would like to know more about the services
        that they provide.
      </p>
      ...
      <p>
        Hari Rana is a Flatpak, GNOME and Fedora contributor, the co-maintainer
        of{" "}
      ...
      <p>
        ...
        . Funded by community sponsors, he provides free design services such as
        application icon creation for Free and Open Source projects. See{" "}
...
export default ConsultantsClient
